...
function program14(depth0,data) {
  ...
  return "\n          <h4>参数列表</h4>\n          <table class='fullwidth'>\n          <thead>\n            <tr>\n            <th style=\"width: 100px; max-width: 100px\">参数名称</th>\n            <th style=\"width: 310px; max-width: 310px\">值</th>\n            <th style=\"width: 200px; max-width: 200px\">详细描述</th>\n            <th style=\"width: 100px; max-width: 100px\">参数传递方式</th>\n            <th style=\"width: 220px; max-width: 230px\">数据类型</th>\n            </tr>\n          </thead>\n          <tbody class=\"operation-params\">\n\n          </tbody>\n          </table>\n          ";
  }
...
function program1(depth0,data) {
  ...
  var buffer = "", stack1;
  buffer += "\n        <textarea class='body-textarea'  readonly='readonly' placeholder='(必须填写)' name='";
  if (stack1 = helpers.name) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.name; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "'>";
...
function program5(depth0,data) {
  ...
  var buffer = "", stack1;
  buffer += "\n				<textarea class='body-textarea' placeholder='(必须填写)' name='";
  if (stack1 = helpers.name) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.name; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "'>";
...
function program13(depth0,data) {
  ...
  buffer += escapeExpression(stack1)
    + "' placeholder='(必须填写)' type='text' value='";
  if (stack1 = helpers.defaultValue) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.defaultValue; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "'/>\n			";
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<div>\n<ul class=\"signature-nav\">\n    <li><a class=\"description-link\" href=\"#\">模型</a></li>\n    <li><a class=\"snippet-link\" href=\"#\">模型测试</a></li>\n</ul>\n<div>\n\n<div class=\"signature-container\">\n    <div class=\"description\">\n        ";
...
(function() {
  ...
  SignatureView = (function(_super) {
    ...
    SignatureView.prototype.render = function() {
      ...
      if (this.isParam) {
        $('.notice', $(this.el)).text('单击鼠标左键将模型设为参数');
      }
      return this;
    };
  ...
  ParameterContentTypeView = (function(_super) {
    ...
    ParameterContentTypeView.prototype.render = function() {
      ...
      template = this.template();
      $(this.el).html(template(this.model));
      $('label[for=parameterContentType]', $(this.el)).text('数据包装方式:');
      return this;
    };
